    ...
    SdkInfo.prototype.setupOnce = function (addGlobalEventProcessor) {
        ...
        addGlobalEventProcessor(function (event) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        if (!(wrapper_1.NATIVE.platform === 'ios' && this._nativeSdkInfo === null)) return [3 /*break*/, 4];
                        _b.label = 1;
                    case 1:
                        _b.trys.push([1, 3, , 4]);
                        _a = this;
                    ...
                    case 4:
                        ...
                        event.sdk = tslib_1.__assign(tslib_1.__assign({}, event.sdk), { name: version_1.SDK_NAME, packages: tslib_1.__spread(((event.sdk && event.sdk.packages) || []), ((this._nativeSdkInfo && [this._nativeSdkInfo]) || []), [
                                {
